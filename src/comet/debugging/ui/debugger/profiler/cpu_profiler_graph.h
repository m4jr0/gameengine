...
#ifndef COMET_COMET_DEBUGGING_UI_DEBUGGER_PROFILER_CPU_PROFILER_GRAPH_H_
#define COMET_COMET_DEBUGGING_UI_DEBUGGER_PROFILER_CPU_PROFILER_GRAPH_H_
...
#endif  // COMET_COMET_DEBUGGING_UI_DEBUGGER_PROFILER_CPU_PROFILER_GRAPH_H_