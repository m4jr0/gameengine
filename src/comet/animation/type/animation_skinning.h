...
#ifndef COMET_COMET_ANIMATION_TYPE_ANIMATION_SKINNING_H_
#define COMET_COMET_ANIMATION_TYPE_ANIMATION_SKINNING_H_
...
#endif  // COMET_COMET_ANIMATION_TYPE_ANIMATION_SKINNING_H_