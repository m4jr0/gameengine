...
#ifndef COMET_RUNTIME_LOGIC_GAME_LOGIC_MANAGER_H_
#define COMET_RUNTIME_LOGIC_GAME_LOGIC_MANAGER_H_
...
class GameLogicManager
    : public Manager {  // >:3 Rename to SimulationManager or LogicFrameManager.
 public:
...
#endif  // COMET_RUNTIME_LOGIC_GAME_LOGIC_MANAGER_H_
