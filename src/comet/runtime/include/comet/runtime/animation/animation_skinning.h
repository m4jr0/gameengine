...
#ifndef COMET_RUNTIME_ANIMATION_ANIMATION_SKINNING_H_
#define COMET_RUNTIME_ANIMATION_ANIMATION_SKINNING_H_
...
#endif  // COMET_RUNTIME_ANIMATION_ANIMATION_SKINNING_H_