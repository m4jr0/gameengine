...
#ifndef COMET_RUNTIME_GEOMETRY_COMPONENT_MESH_COMPONENT_H_
#define COMET_RUNTIME_GEOMETRY_COMPONENT_MESH_COMPONENT_H_
...
#endif  // COMET_RUNTIME_GEOMETRY_COMPONENT_MESH_COMPONENT_H_