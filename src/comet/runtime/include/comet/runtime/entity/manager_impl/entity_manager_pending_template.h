...
#ifndef COMET_RUNTIME_ENTITY_MANAGER_IMPL_ENTITY_MANAGER_PENDING_TEMPLATE_H_
#define COMET_RUNTIME_ENTITY_MANAGER_IMPL_ENTITY_MANAGER_PENDING_TEMPLATE_H_
...
#endif  // COMET_RUNTIME_ENTITY_MANAGER_IMPL_ENTITY_MANAGER_PENDING_TEMPLATE_H_