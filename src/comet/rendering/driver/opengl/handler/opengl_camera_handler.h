...
#ifndef COMET_COMET_RENDERING_DRIVER_OPENGL_HANDLER_OPENGL_CAMERA_HANDLER_H_
#define COMET_COMET_RENDERING_DRIVER_OPENGL_HANDLER_OPENGL_CAMERA_HANDLER_H_
...
#endif  // COMET_COMET_RENDERING_DRIVER_OPENGL_HANDLER_OPENGL_CAMERA_HANDLER_H_