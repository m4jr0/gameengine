...
class RenderProxyHandler : public Handler {
 ...
 private:
  ...
  StorageHandle ssbo_proxy_local_data_handle_{kInvalidStorageHandle};
  StorageHandle ssbo_word_indices_handle_{kInvalidStorageHandle};
  StorageHandle ssbo_proxy_local_data_ids_handle_{kInvalidStorageHandle};
  ...
  Array<RenderBatchEntry> new_batch_entries_;
  Array<RenderBatchEntry> destroyed_batch_entries_;
  Array<RenderProxy> destroyed_proxies_;
  ...
  frame::FrameArray<GpuRenderProxyLocalData>* pending_proxy_local_data_{
      nullptr};
  frame::FrameArray<VkBufferMemoryBarrier>* post_update_barriers_{nullptr}; // >:3 Check useless stuff.
