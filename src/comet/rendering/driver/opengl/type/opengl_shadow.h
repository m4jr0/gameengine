...
#ifndef COMET_COMET_RENDERING_DRIVER_OPENGL_TYPE_OPENGL_SHADOW_H_
#define COMET_COMET_RENDERING_DRIVER_OPENGL_TYPE_OPENGL_SHADOW_H_
...
#endif  // COMET_COMET_RENDERING_DRIVER_OPENGL_TYPE_OPENGL_SHADOW_H_