...
#ifndef COMET_COMET_RENDERING_DRIVER_OPENGL_TYPE_OPENGL_SHADER_H_
#define COMET_COMET_RENDERING_DRIVER_OPENGL_TYPE_OPENGL_SHADER_H_
...
#endif  // COMET_COMET_RENDERING_DRIVER_OPENGL_TYPE_OPENGL_SHADER_H_