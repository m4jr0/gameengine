...
#ifndef COMET_COMET_RENDERING_DRIVER_OPENGL_UTILS_OPENGL_VIEW_SHADER_UTILS_H_
#define COMET_COMET_RENDERING_DRIVER_OPENGL_UTILS_OPENGL_VIEW_SHADER_UTILS_H_
...
#endif  // COMET_COMET_RENDERING_DRIVER_OPENGL_UTILS_OPENGL_VIEW_SHADER_UTILS_H_