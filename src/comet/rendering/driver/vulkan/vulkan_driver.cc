...
void VulkanDriver::OnInitialize() {
  ...
  CameraManager::Get().SetProjectionFlags(kProjectionFlagBitsInvertY |
                                          kProjectionFlagBitsDepthZeroToOne);
}
...
void VulkanDriver::InitializeHandlers() {
  ...
  debug_handler_descr.context = context_.get();
  ...
  camera_handler_descr.context = context_.get();
