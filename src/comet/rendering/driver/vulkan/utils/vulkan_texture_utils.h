...
#ifndef COMET_COMET_RENDERING_DRIVER_VULKAN_UTILS_VULKAN_TEXTURE_UTILS_H_
#define COMET_COMET_RENDERING_DRIVER_VULKAN_UTILS_VULKAN_TEXTURE_UTILS_H_
...
#endif  // COMET_COMET_RENDERING_DRIVER_VULKAN_UTILS_VULKAN_TEXTURE_UTILS_H_
