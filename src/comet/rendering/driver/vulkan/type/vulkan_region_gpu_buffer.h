...
#ifndef COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_REGION_GPU_BUFFER_H_
#define COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_REGION_GPU_BUFFER_H_
...
#endif  // COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_REGION_GPU_BUFFER_H_
