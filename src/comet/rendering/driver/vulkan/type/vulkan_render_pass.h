...
#ifndef COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_RENDER_PASS_H_
#define COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_RENDER_PASS_H_
...
#endif  // COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_RENDER_PASS_H_
