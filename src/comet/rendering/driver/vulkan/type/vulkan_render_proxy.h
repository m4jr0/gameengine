...
#ifndef COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_RENDER_PROXY_TYPE_H_
#define COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_RENDER_PROXY_TYPE_H_
...
struct RenderProxyModelBindings {
  RenderProxyModelBindings() = default;

  explicit RenderProxyModelBindings(memory::Allocator* allocator)
      : proxy_ids{allocator} {}
...
#endif  // COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_RENDER_PROXY_TYPE_H_
