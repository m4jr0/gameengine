...
#ifndef COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_FRAME_TYPE_H_
#define COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_FRAME_TYPE_H_
...
#endif  // COMET_COMET_RENDERING_DRIVER_VULKAN_TYPE_VULKAN_FRAME_TYPE_H_
