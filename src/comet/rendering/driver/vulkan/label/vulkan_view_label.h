...
#ifndef COMET_COMET_RENDERING_DRIVER_VULKAN_LABEL_VULKAN_VIEW_LABEL_H_
#define COMET_COMET_RENDERING_DRIVER_VULKAN_LABEL_VULKAN_VIEW_LABEL_H_
...
#endif  // COMET_COMET_RENDERING_DRIVER_VULKAN_LABEL_VULKAN_VIEW_LABEL_H_