...
#ifndef COMET_COMET_RENDERING_DRIVER_VULKAN_HANDLER_VULKAN_CAMERA_HANDLER_H_
#define COMET_COMET_RENDERING_DRIVER_VULKAN_HANDLER_VULKAN_CAMERA_HANDLER_H_
...
#endif  // COMET_COMET_RENDERING_DRIVER_VULKAN_HANDLER_VULKAN_CAMERA_HANDLER_H_