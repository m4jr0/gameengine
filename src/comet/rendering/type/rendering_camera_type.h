...
#ifndef COMET_COMET_RENDERING_TYPE_RENDERING_CAMERA_TYPE_H_
#define COMET_COMET_RENDERING_TYPE_RENDERING_CAMERA_TYPE_H_
...
#endif  // COMET_COMET_RENDERING_TYPE_RENDERING_CAMERA_TYPE_H_