...
#ifndef COMET_COMET_RENDERING_LABEL_RENDERING_TEXTURE_LABEL_H_
#define COMET_COMET_RENDERING_LABEL_RENDERING_TEXTURE_LABEL_H_
...
#endif  // COMET_COMET_RENDERING_LABEL_RENDERING_TEXTURE_LABEL_H_