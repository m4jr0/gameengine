...
#ifndef COMET_COMET_RENDERING_LABEL_PIPELINE_LABEL_H_
#define COMET_COMET_RENDERING_LABEL_PIPELINE_LABEL_H_
...
#endif  // COMET_COMET_RENDERING_LABEL_PIPELINE_LABEL_H_