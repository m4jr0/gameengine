...
ShaderProgram::ShaderProgram(const ShaderProgram& other)
  ...
  can_be_initialized_ =
      !vertex_shader_code_.empty() && !fragment_shader_code_.empty();
}
...
const unsigned int ShaderProgram::GetId() const noexcept { return id_; }
