...
#ifndef COMET_COMET_RENDERING_UTILS_RENDERING_GEOMETRY_UTILS_H_
#define COMET_COMET_RENDERING_UTILS_RENDERING_GEOMETRY_UTILS_H_
...
#endif  // COMET_COMET_RENDERING_UTILS_RENDERING_GEOMETRY_UTILS_H_