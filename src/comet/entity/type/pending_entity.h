...
#ifndef COMET_COMET_ENTITY_TYPE_PENDING_ENTITY_TYPE_H_
#define COMET_COMET_ENTITY_TYPE_PENDING_ENTITY_TYPE_H_
...
#endif  // COMET_COMET_ENTITY_TYPE_PENDING_ENTITY_TYPE_H_
