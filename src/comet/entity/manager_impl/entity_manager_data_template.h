...
#ifndef COMET_COMET_ENTITY_MANAGER_IMPL_ENTITY_MANAGER_DATA_TEMPLATE_H_
#define COMET_COMET_ENTITY_MANAGER_IMPL_ENTITY_MANAGER_DATA_TEMPLATE_H_
...
#endif  // COMET_COMET_ENTITY_MANAGER_IMPL_ENTITY_MANAGER_DATA_TEMPLATE_H_