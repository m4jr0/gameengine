...
#ifndef COMET_COMET_DEBUG_UI_DEBUGGER_PROFILER_CPU_PROFILER_DISPLAYER_CONTEXT_H_
#define COMET_COMET_DEBUG_UI_DEBUGGER_PROFILER_CPU_PROFILER_DISPLAYER_CONTEXT_H_
...
#endif  // COMET_COMET_DEBUG_UI_DEBUGGER_PROFILER_CPU_PROFILER_DISPLAYER_CONTEXT_H_