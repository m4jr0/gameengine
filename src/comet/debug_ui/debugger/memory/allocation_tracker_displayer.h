...
#ifndef COMET_COMET_DEBUG_UI_DEBUGGER_MEMORY_ALLOCATION_TRACKER_DISPLAYER_H_
#define COMET_COMET_DEBUG_UI_DEBUGGER_MEMORY_ALLOCATION_TRACKER_DISPLAYER_H_
...
#endif  // COMET_COMET_DEBUG_UI_DEBUGGER_MEMORY_ALLOCATION_TRACKER_DISPLAYER_H_