...
// Header. /////////////////////////////////////////////////////////////////////
#include "comet/engine/debug/ui/rendering/rendering_debug_ui.h"
////////////////////////////////////////////////////////////////////////////////
...
namespace comet {
namespace debug {
void RenderingDebugUi::Draw(RenderingDebugSettings& settings) {
...
void RenderingDebugUi::DrawWorldFlags(const char* label,
...
void RenderingDebugUi::DrawDebugDrawFlags(const char* label,
                                          RenderingDebugSettings& settings,
                                          bool is_debug_camera) {
  if (!ImGui::TreeNode(label)) {
    return;
...
void RenderingDebugUi::DrawCameraInfo(rendering::CameraManager& camera_manager,
