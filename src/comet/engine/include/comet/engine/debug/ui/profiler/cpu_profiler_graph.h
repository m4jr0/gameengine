...
#ifndef COMET_ENGINE_DEBUG_UI_PROFILER_CPU_PROFILER_GRAPH_H_
#define COMET_ENGINE_DEBUG_UI_PROFILER_CPU_PROFILER_GRAPH_H_
...
#endif  // COMET_ENGINE_DEBUG_UI_PROFILER_CPU_PROFILER_GRAPH_H_