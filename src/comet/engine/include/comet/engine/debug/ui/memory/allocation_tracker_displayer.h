...
#ifndef COMET_ENGINE_DEBUG_UI_MEMORY_ALLOCATION_TRACKER_DISPLAYER_H_
#define COMET_ENGINE_DEBUG_UI_MEMORY_ALLOCATION_TRACKER_DISPLAYER_H_
...
#endif  // COMET_ENGINE_DEBUG_UI_MEMORY_ALLOCATION_TRACKER_DISPLAYER_H_