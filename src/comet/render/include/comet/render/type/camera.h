...
#ifndef COMET_RENDER_TYPE_CAMERA_H_
#define COMET_RENDER_TYPE_CAMERA_H_
...
namespace comet { // >:3 Remove type/ everywhere (and vulkan/opengl name prefixes???).
namespace rendering {
...
#endif  // COMET_RENDER_TYPE_CAMERA_H_