...
#ifndef COMET_RENDER_DEBUG_RENDERING_DEBUG_SETTINGS_H_
#define COMET_RENDER_DEBUG_RENDERING_DEBUG_SETTINGS_H_
...
#endif  // COMET_RENDER_DEBUG_RENDERING_DEBUG_SETTINGS_H_