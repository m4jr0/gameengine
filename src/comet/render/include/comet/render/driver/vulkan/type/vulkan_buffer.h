...
#ifndef COMET_RENDER_DRIVER_VULKAN_TYPE_VULKAN_BUFFER_H_
#define COMET_RENDER_DRIVER_VULKAN_TYPE_VULKAN_BUFFER_H_
...
#endif  // COMET_RENDER_DRIVER_VULKAN_TYPE_VULKAN_BUFFER_H_
