...
#ifndef COMET_RENDER_DRIVER_VULKAN_UTILS_VULKAN_DESCRIPTOR_UTILS_H_
#define COMET_RENDER_DRIVER_VULKAN_UTILS_VULKAN_DESCRIPTOR_UTILS_H_
...
#endif  // COMET_RENDER_DRIVER_VULKAN_UTILS_VULKAN_DESCRIPTOR_UTILS_H_
