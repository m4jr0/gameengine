...
#ifndef COMET_RENDER_DRIVER_VULKAN_VIEW_VULKAN_VIEW_H_
#define COMET_RENDER_DRIVER_VULKAN_VIEW_VULKAN_VIEW_H_
...
#endif  // COMET_RENDER_DRIVER_VULKAN_VIEW_VULKAN_VIEW_H_