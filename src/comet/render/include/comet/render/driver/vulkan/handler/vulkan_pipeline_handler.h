...
#ifndef COMET_RENDER_DRIVER_VULKAN_HANDER_VULKAN_PIPELINE_HANDLER_H_
#define COMET_RENDER_DRIVER_VULKAN_HANDER_VULKAN_PIPELINE_HANDLER_H_
...
#endif  // COMET_RENDER_DRIVER_VULKAN_HANDER_VULKAN_PIPELINE_HANDLER_H_