...
#ifndef COMET_RENDER_DRIVER_VULKAN_TYPE_VULKAN_SAMPLER_H_
#define COMET_RENDER_DRIVER_VULKAN_TYPE_VULKAN_SAMPLER_H_
...
#endif  // COMET_RENDER_DRIVER_VULKAN_TYPE_VULKAN_SAMPLER_H_