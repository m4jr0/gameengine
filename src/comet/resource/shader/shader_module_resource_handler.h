...
#ifndef COMET_COMET_RESOURCE_SHADER_SHADER_MODULE_RESOURCE_HANDLER_H_
#define COMET_COMET_RESOURCE_SHADER_SHADER_MODULE_RESOURCE_HANDLER_H_
...
#endif  // COMET_COMET_RESOURCE_SHADER_SHADER_MODULE_RESOURCE_HANDLER_H_
