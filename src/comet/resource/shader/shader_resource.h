...
#ifndef COMET_COMET_RESOURCE_SHADER_SHADER_RESOURCE_H_
#define COMET_COMET_RESOURCE_SHADER_SHADER_RESOURCE_H_
...
#endif  // COMET_COMET_RESOURCE_SHADER_SHADER_RESOURCE_H_