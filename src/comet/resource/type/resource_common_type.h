...
#ifndef COMET_COMET_RESOURCE_TYPE_RESOURCE_COMMON_TYPE_H_
#define COMET_COMET_RESOURCE_TYPE_RESOURCE_COMMON_TYPE_H_
...
#endif  // COMET_COMET_RESOURCE_TYPE_RESOURCE_COMMON_TYPE_H_