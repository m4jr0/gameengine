...
#ifndef COMET_CORE_ALGORITHM_SORT_H_
#define COMET_CORE_ALGORITHM_SORT_H_
...
void Sort(Iterator begin, Iterator end, memory::Allocator* allocator,
  ...
  InplaceMerge(begin, middle, end, allocator, comparer);
}
}  // namespace comet

#endif  // COMET_CORE_ALGORITHM_SORT_H_
