...
#ifndef COMET_CORE_FILE_SYSTEM_FILE_SYSTEM_H_
#define COMET_CORE_FILE_SYSTEM_FILE_SYSTEM_H_
...
using FileSystemAllocatorGetter = memory::Allocator* (*)();
...
#endif  // COMET_CORE_FILE_SYSTEM_FILE_SYSTEM_H_
