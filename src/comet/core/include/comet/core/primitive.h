...
#ifndef COMET_CORE_PRIMITIVE_H_
#define COMET_CORE_PRIMITIVE_H_
...
// Max bytes needed to encode a single wchar as multibyte (locale-dependent).
constexpr auto kMbCharMaxLen{MB_LEN_MAX};
constexpr std::size_t kInvalidMbLen{static_cast<std::size_t>(-1)};
