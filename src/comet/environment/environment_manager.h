...
#ifndef COMET_COMET_ENVIRONMENT_ENVIRONMENT_MANAGER_H_
#define COMET_COMET_ENVIRONMENT_ENVIRONMENT_MANAGER_H_
...
#endif  // COMET_COMET_ENVIRONMENT_ENVIRONMENT_MANAGER_H_
